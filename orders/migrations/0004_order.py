    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shipping_total_price', models.DecimalField(default=5.95, max_digits=50, decimal_places=2)),
                ...
                ('shipping_address', models.ForeignKey(related_name='shiping_address', to='orders.UserAddress')),
