...
#Creo que SingleObjectMixin sirve para sacar el object
class CartView(SingleObjectMixin,View):
    ...
    #Obtiene qty,item que le pasa por la url
    def get(self,request,*args, **kwargs):
        ...
        if item_id:
            ...
            if created:
                flash_message="Succesfully Added to the cart."
                item_added = True
            if delete_item:
            ...
            if not request.is_ajax():
                ...
                #return cart_item.cart.get_absolute.url()
...
class CheckoutView(CartOrderMixin,FormMixin,DetailView):
    ...
    def get_context_data(self,*args, **kwargs):
        ...
        if user_check_id != None:
            user_can_continue= True
            if not self.request.user.is_authenticated(): #GUEST_USER
    ...
    def post(self, request, *args, **kwargs):
        ...
        if nonce:
            result = braintree.Transaction.sale({
                ...
                "billing":{
                    "postal_code": "%s" % (order.billing_address.zip_code)
                },
                "options":{
